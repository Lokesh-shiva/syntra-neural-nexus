    ...
    <footer className="py-12 px-4 border-t border-white/10">
      <div className="container mx-auto max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-10">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li><Link to="/workflow" className="hover:text-white transition-colors">Workflow</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li><Link to="/simulate" className="hover:text-white transition-colors">Simulation</Link></li>
        ...
        <div className="border-t border-white/10 pt-6 flex flex-col md:flex-row justify-between items-center">
          <div className="text-gray-500 text-sm order-2 md:order-1 mt-4 md:mt-0">
            © {new Date().getFullYear()} Orbynet. All rights reserved.
          </div>
